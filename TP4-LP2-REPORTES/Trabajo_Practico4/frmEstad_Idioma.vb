Public Class frmEstad_Idioma
    Private Sub btnListar_Click(sender As Object, e As EventArgs) Handles btnListar.Click
        listar_estad("Idioma", "IdIdioma", dgvEstad, txtListados, txtTotalCant, txtTotalPrecios)
    End Sub

    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        exportar_estad("Idioma", "IdIdioma")
    End Sub
    ...
    Private Sub PrintDocument_estad_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument_estad.PrintPage
        ...
        e.Graphics.DrawString("Estadisticas de Idiomas", titulo, Brushes.Black, 80, 50)
